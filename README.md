...
```shell
gem install ./build_client-1.0.25.gem
```

(for development, run `gem install --dev ./build_client-1.0.25.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'build_client', '~> 1.0.25'
...
*BuildClient::PipelinesApi* | [**get_pipeline**](docs/PipelinesApi.md#get_pipeline) | **GET** /api/v1/pipelines/{id} | get a specific pipeline
...
## Documentation for Models
 ...
 - [BuildClient::Error](docs/Error.md)
