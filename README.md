...
```shell
gem install ./build_client-1.1.6.gem
```

(for development, run `gem install --dev ./build_client-1.1.6.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'build_client', '~> 1.1.6'
