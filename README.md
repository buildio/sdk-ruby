...
```shell
gem install ./build_client-1.0.21.gem
```

(for development, run `gem install --dev ./build_client-1.0.21.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'build_client', '~> 1.0.21'
...
*BuildClient::ReviewAppsApi* | [**create_review_app**](docs/ReviewAppsApi.md#create_review_app) | **POST** /api/v1/pipelines/{pipeline_id}/review_apps | create a review app
*BuildClient::ReviewAppsApi* | [**delete_review_app**](docs/ReviewAppsApi.md#delete_review_app) | **DELETE** /api/v1/review_apps/{id} | delete a review app
*BuildClient::ReviewAppsApi* | [**get_review_app**](docs/ReviewAppsApi.md#get_review_app) | **GET** /api/v1/review_apps/{id} | get a specific review app
...
*BuildClient::ReviewAppsApi* | [**list_review_apps**](docs/ReviewAppsApi.md#list_review_apps) | **GET** /api/v1/pipelines/{pipeline_id}/review_apps | list review apps for a pipeline
